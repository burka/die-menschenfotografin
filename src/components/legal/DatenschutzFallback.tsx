...
interface DatenschutzFallbackProps {
  settings: SiteSettingsData
  addressClassName?: string
}

/**
 * Shared fallback content for Datenschutz (used by both LegalOverlay and /datenschutz page)
 */
export function DatenschutzFallback({ settings, addressClassName }: DatenschutzFallbackProps) {
  return (
    <>
